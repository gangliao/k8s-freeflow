...
MemPool::MemPool() { pthread_spin_init(&m_lock, PTHREAD_PROCESS_PRIVATE); }

MemPool::~MemPool() { pthread_spin_destroy(&m_lock); }
...
MemQueue::MemQueue() { pthread_spin_init(&m_lock, PTHREAD_PROCESS_PRIVATE); }

MemQueue::~MemQueue() { pthread_spin_destroy(&m_lock); }
